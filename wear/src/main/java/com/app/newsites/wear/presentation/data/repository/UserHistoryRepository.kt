package com.app.newsites.wear.presentation.data.repository
...
class UserHistoryRepository {
    ...
    suspend fun getSiteData(siteId: String): Map<String, Any?>? {
        return try {
            ...
            Log.e("UserRepository", "Error getting site data", e)
            null
        }
    }
